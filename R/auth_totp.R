...
# -----------------------------------------------------
#
# NOTA DE SEGURANÇA: esta função usa o gerador de números
# aleatórios padrão do R (Mersenne Twister via sample()),
# que não é criptograficamente seguro. Para um ambiente de
# produção mais rigoroso, recomenda-se substituir por uma
# fonte segura, por exemplo:
#   openssl::rand_bytes(n) convertido para o alfabeto base32.
# Mantido como no original para não alterar comportamento
