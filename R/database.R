...
# }
#
# conectar_banco_tjse <- function() {
#
#     drv <- JDBC(
#         driverClass = Sys.getenv(
#             "TJSE_IRIS_DRIVER_CLASS",
#             unset = "com.intersystems.jdbc.IRISDriver"
#         ),
#         classPath = Sys.getenv("MPRO_IRIS_JAR_PATH")
#     )
...
#     dbConnect(
#         drv,
#         Sys.getenv("TJSE_IRIS_URL"),
#         user = Sys.getenv("TJSE_IRIS_USER"),
#         password = Sys.getenv("TJSE_IRIS_PASS")
#     )
#
# }
